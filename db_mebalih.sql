...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2017 at 08:17 AM
...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  `id_ticket_class` int(11) NOT NULL,
  `id_ticket_seat` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `confirm_payment` (
  ...
  `account_num` varchar(150) NOT NULL,
  `news` varchar(300) NOT NULL,
  `total_confirm_price` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `id_contact_cat` int(11) NOT NULL,
...
--
-- Table structure for table `contact_cat`
--

CREATE TABLE IF NOT EXISTS `contact_cat` (
  `id_contact_cat` int(11) NOT NULL AUTO_INCREMENT,
  `category_name` varchar(50) NOT NULL,
  PRIMARY KEY (`id_contact_cat`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `deposit_transaction` (
  `id_deposit_transaction` int(11) NOT NULL AUTO_INCREMENT,
  `id_deposit` int(11) NOT NULL,
  `dp_type` varchar(50) NOT NULL,
  `total_dp` int(11) NOT NULL,
  `status` char(1) NOT NULL,
  PRIMARY KEY (`id_deposit_transaction`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `page` (
  ...
  `id_page_category` int(11) NOT NULL,
  `date` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `page_category` (
  `id_page_category` int(11) NOT NULL AUTO_INCREMENT,
  `page_cat_name` varchar(30) NOT NULL,
  `desc` text NOT NULL,
  PRIMARY KEY (`id_page_category`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `payment_category` (
  `id_payment_category` int(11) NOT NULL AUTO_INCREMENT,
  `payment_cat_name` varchar(50) NOT NULL,
  `desc` text NOT NULL,
  PRIMARY KEY (`id_payment_category`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  `date` datetime NOT NULL,
  `address` text NOT NULL,
  `inclusion` varchar(400) NOT NULL,
  `img` varchar(200) NOT NULL,
  `status` char(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ticket_category` (
  `id_ticket_category` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ticket_class` (
  `id_ticket_class` int(11) NOT NULL AUTO_INCREMENT,
  `id_ticket` int(11) NOT NULL,
  `class_name` varchar(100) NOT NULL,
  `price` int(11) NOT NULL,
  `desc` text NOT NULL,
  `capacity` int(11) NOT NULL,
  PRIMARY KEY (`id_ticket_class`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ticket_seat` (
  `id_ticket_seat` int(11) NOT NULL AUTO_INCREMENT,
  `id_ticket` int(11) NOT NULL,
  `gate` varchar(50) NOT NULL,
  `row` varchar(50) NOT NULL,
  `seat` varchar(50) NOT NULL,
  PRIMARY KEY (`id_ticket_seat`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
